...
const Buttons = ({ setMenuOpen }) => (
  <div className="flex items-center gap-4">
    ...
    <a
      href="https://pump.fun/coin/D2FYnybuGU2BeUGynZ3fTc2XqUF2d9JkRPfe9whDpump" // Replace with the actual Buy $Check link
      target="_blank"
      rel="noopener noreferrer"
  ...
  return (
    ...
    >
      <div ref={ref} className="flex flex-col items-start gap-4 px-4 pb-4">
        ...
        <ExternalLink href="https://pump.fun/coin/D2FYnybuGU2BeUGynZ3fTc2XqUF2d9JkRPfe9whDpump" text="Buy $Check" />
      </div>
    </motion.div>
  );
};
